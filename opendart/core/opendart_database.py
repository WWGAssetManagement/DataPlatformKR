...
from config.settings import OPENDART_ENGINE, META


class OpenDartDatabase:
    model = None
    table = None
    conn = None
    ...
    def __init__(self, model):
        ...
        self.conn = OPENDART_ENGINE.connect()


    def __get_table(self, model) -> Table:
        return Table(model.__tablename__, META, autoload_with=OPENDART_ENGINE)
